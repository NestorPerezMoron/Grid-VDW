...
#Extract the information of GridParameters.txt
set Data [read [open ../../../GridParameters.txt r]]

foreach lines [split $Data "\n"] {
	lappend AllParameters  $lines
}
...
set SystemPDB [lindex [lindex $AllParameters 5] 1];	#pdb file of system
set SystemPSF [lindex [lindex $AllParameters 6] 1];	#psf file of system
set SystemDCD [lindex [lindex $AllParameters 7] 1];	#dcd file of equilibration

#Type of grid: Carbon, Nitrogen, Oxygen and Sulfur
set GridType [lindex [lindex $AllParameters 32] 1];     #Type of grid

#Name of Grid File
set Output [lindex [lindex $AllParameters 9] 1];	#Output Name
...
#Parameters
set GridPoints [lindex $AllParameters 17];

#set PointStart [lindex [lindex $AllParameters 19] 1];
#set PointFinish [ expr $PointStart + 1 ]

set GridOrigin [lindex $AllParameters 22];

set GridDeltaX [lindex $AllParameters 25];
set GridDeltaY [lindex $AllParameters 27];
set GridDeltaZ [lindex $AllParameters 29];
...
file delete Frame.$Frame.$PointStart.$GridType.log ../
